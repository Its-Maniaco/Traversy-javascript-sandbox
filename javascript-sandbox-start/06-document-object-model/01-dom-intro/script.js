...
console.log(document.links[0]); // links is array of all the links on page

// We can set properties of elements
// document.body.innerHTML = '<h1>Hello from body</h1>'; //Replace whole body with this
